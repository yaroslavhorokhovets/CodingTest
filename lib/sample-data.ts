...
export const sampleWebinarSlots: WebinarSlot[] = [
  {
    ...
    everwebinarUrl: 'https://demo.everwebinar.com/session/sales-training-12345', // Will use mock
  ...
  },
  {
    ...
    everwebinarUrl: 'https://demo.everwebinar.com/session/product-demo-67890', // Will use mock
  ...
  },
  {
    ...
    everwebinarUrl: 'https://demo.everwebinar.com/session/qna-session-11111', // Will use mock
...
export const sampleZoomConfigs = {
  morning_sales_training: {
    ...
    leaveUrl: typeof window !== 'undefined' ? window.location.href : 'http://localhost:3000',
